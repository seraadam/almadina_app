...
public class ExploreCategory {
    ...
    public ExploreCategory(String title, int imageResourceId, String location, int reviewStart, String[] stringArray) {
        itemTitle = title;
    ...
    public ExploreCategory(String title, int imageResourceId, String location, int reviewStar, String[] highlights, String overview, String provider, float price) {
        itemTitle = title;
        itemImageResourceId = imageResourceId;
        itemLocation = location;
